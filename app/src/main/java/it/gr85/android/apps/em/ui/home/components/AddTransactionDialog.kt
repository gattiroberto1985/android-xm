...
fun AddTransactionDialog(
    onDismiss: () -> Unit,
    onConfirm: (description: String, amount: String, category: String, movementType: MovementType) -> Unit,
    ...
    var transactionType by remember { mutableStateOf(MovementType.EXPENSE) }
    ...
    AppTheme {
        Surface {
            AddTransactionDialog(
                ...
                movementTypes = MovementType.entries.toList()
            )
        }
    }
}
